  ...
  return (
    <motion.div
      ...
      <Link
        ...
        className="relative flex items-center group justify-between gap-2 lg:min-h-60 w-full py-7 md:px-10 px-4 p-5 rounded-sm bg-[#171d16] backdrop-blur-lg border border-border-color">
